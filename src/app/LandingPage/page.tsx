    ...
    <div className="space-y-4">
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center">
          <span className="px-4 text-sm text-gray-600 bg-white rounded-full">or</span>
        </div>
      </div>
    ...
    <div className="mt-8 text-center space-y-4">
      ...
      <div className="text-center text-xs pt-5">
        <p className="text-gray-600">
          ...
          <a href="/info/terms" className="text-gray-900 hover:text-black underline decoration-1 underline-offset-2 hover:decoration-gray-600 transition-colors font-medium">
            Terms & Conditions
          </a>
          {' '}and{' '}
          <a href="/info/privacy" className="text-gray-900 hover:text-black underline decoration-1 underline-offset-2 hover:decoration-gray-600 transition-colors font-medium">
            Privacy Policy
          </a>
        </p>
      </div>
