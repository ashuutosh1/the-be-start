        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 max-md:p-4">
          ...
          <div className="p-4 mx-auto md:pt-10 space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-600">Bemaxo.com exclusively displays advertisements through Google Ads. We do not allow third-party ad networks, direct marketing, or external ad placements on our platform. Our advertising system follows Google's policies to ensure quality and compliance.</p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-600">All advertisements displayed on Bemaxo.com comply with Google Ads policies. We strictly prohibit deceptive, harmful, or inappropriate ads, including those promoting restricted content, false claims, or violating community standards.</p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-600">We respect user privacy and ensure that all ads comply with Google’s data protection and transparency policies. Any cookies or tracking mechanisms used align with GDPR, CCPA, and other relevant regulations.</p>
            </section>
          </div>
