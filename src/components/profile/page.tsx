...
export default function ProfilePage() {
    ...
    const tabs = [
        ...
        { id: 'trends', label: 'Trends', count: 156 }
    ];
                ...
                <div className="grid grid-cols-1 md:grid-cols-[auto,1fr] lg:grid-cols-[auto,1fr,auto]">
                    ...
                    <main className="min-h-screen px-4 sm:px-6">
                        ...
                        <div className="py-4">
                            ...
                            {/* Profile Photo - Square, overlapping cover on right side */}
                            <div className="relative px-4 sm:px-6">
                                <div className="absolute -top-16 right-4 sm:right-6">
                                    <div className="w-32 h-32 rounded-2xl border-4 border-white dark:border-gray-900 overflow-hidden bg-white dark:bg-gray-800 shadow-xl">
                                        <Image
                                ...
                                <div className="pt-5 flex flex-col sm:flex-row sm:justify-between sm:items-start">
                                    ...
                                    {/* Right Side: Edit button - positioned to not overlap with profile image */}
                                    <div className="mt-4 sm:mt-0 sm:mr-40">
                                        <button className="text-gray-900 dark:text-white px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-full hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors font-medium">
                                            Edit Profile
                                        </button>
                                    </div>
                                </div>
